...
const sortPeople = (arr) => {
  return arr.sort((a, b) =>
    new Intl.Collator('en').compare(a.lastName, b.lastName)
  );
};
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a, b) => {
    const lastNameCompare = new Intl.Collator('en').compare(
      a.lastName,
      b.lastName
    );
    const firstNameCompare = new Intl.Collator('en').compare(
      a.firstName,
      b.firstName
    );
